...
typedef std::function<void(websocketpp::connection_hdl,  const char *, const uint32_t nLength)> NF_WS_CALL_BACK;
typedef std::shared_ptr<NF_WS_CALL_BACK> NF_WS_CALL_BACK_PTR;
