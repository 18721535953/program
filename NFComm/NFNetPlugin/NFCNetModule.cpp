...
{
//todo
//	m_pLogModule->LogInfo("OnReceiveNetPacktesttesttesttesttesttesttesttest " + std::to_string(nMsgID), __FUNCTION__, __LINE__);
...
void NFCNetModule::KeepAlive()
{
    ...
    if (nLastTime + 10000 > GetPluginManager()->GetNowTime())
    {
        return;
    }
