...
public:
	...
	virtual void SendDataToDb(const int nMsgID, NFINT32 task, NFINT64 gameRoomId, short sdataLen, const char * strData) override;
	virtual void SendReadUserInfo(NFINT32 task, NFINT64 gameRoomId, short sdataLen, const char * strData) override;

	virtual void SendGameControl(NFINT32 task, NFINT64 gameRoomId) override;
protected:
...
protected:
	...
	void TransPBToNodeDb(const NFSOCK nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
