...
protected:
	...
	int OnClientLogin(const NFSOCK nSockIndex, const NFGUID clientID, const nlohmann::json& jsonObject);
	//54 MSGID_CLIENT_SIT
	int OnClientSit(const NFSOCK nSockIndex, const NFGUID clientID, const nlohmann::json& jsonObject);
	//56 //MSGID_CLIENT_READY
	//int OnClientReady(const NFSOCK nSockIndex, const NFGUID clientID, const nlohmann::json& jsonObject);
	//58 MSGID_CLIENT_G_BET
	//int OnClienGBet(const NFSOCK nSockIndex, const NFGUID clientID, const nlohmann::json& jsonObject);
...
private:
	...
	NFIGameLogicModule * m_pWorldGameArea;
};
