#ifndef TABLE_STATE_Wager_Two_HPP
#define TABLE_STATE_Wager_Two_HPP
...
class TableStateWagerTwo :public ITableState
{
public:
    TableStateWagerTwo(NFGameTable* pGameTable, NFIPluginManager * p)
    {
    ...
    {
        return TableState::TABLE_WAGER_2;
    }
    ...
    void Enter() override
    {
        ...
        //m_pLogModule->LogInfo("Enter State of Wager Two !");
    }
	...
	NF_MACHINE_STATE Update(float fDeltaTime) override
    {
        ...
        if (m_pGameTable->GetTimeCount() <= 0)
            SetStateTo(TableState::TABLE_FILL_CARD);
    ...
    void Exit() override
    {
        //m_pLogModule->LogInfo("Exit State of Wager Two !");
